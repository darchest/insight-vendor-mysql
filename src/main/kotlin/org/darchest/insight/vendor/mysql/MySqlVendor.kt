...
object MySqlVendor: Vendor {
	...
	private fun sqlToJava() {
		...
		SqlTypeConverter.registerSqlToJava(DatetimeType::class.java, Instant::class.java) { rs, ind ->
			val time = rs.getTimestamp(ind)
			time.toInstant()
		}
